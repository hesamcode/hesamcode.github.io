...
export const metadata: Metadata = {
  title: "HesamCode | توسعه دهنده فرانت اند",
  description:
    "HesamCode - توسعه دهنده فرانت اند. ساخت وبسایت های مدرن و واکنش گرا. مشاهده پروژه ها، درباره من و ارسال درخواست همکاری.",
  ...
  openGraph: {
    ...
    title: "HesamCode | توسعه دهنده فرانت اند",
    description:
      "ساخت وبسایت های مدرن و واکنش گرا | مشاهده پروژه ها و درخواست همکاری",
    images: [
      {
